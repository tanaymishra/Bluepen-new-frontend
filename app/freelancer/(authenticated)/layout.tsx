...
const sidebarGroups: SidebarGroup[] = [
    ...
    },
    {
        title: "Work",
        items: [
            { href: "/freelancer/assignments", label: "Assignments", icon: FileText, comingSoon: true },
            { href: "/freelancer/notifications", label: "Notifications", icon: Bell, comingSoon: true },
        ],
    },
    {
        title: "Finance",
        items: [
            { href: "/freelancer/invoice", label: "Invoice", icon: Receipt, comingSoon: true },
            { href: "/freelancer/rewards", label: "Rewards", icon: Award, comingSoon: true },
        ],
    },
];
    ...
    return (
        <div className="flex min-h-screen bg-[#F5F7FA]">
            ...
            >
                ...
                >
                    {!collapsed && (
                        <Link href="/freelancer/dashboard" className="relative w-28 h-8">
                            <Image
                    ...
                    {collapsed && (
                        <Link href="/freelancer/dashboard" className="relative w-8 h-8">
                            <Image
                                src="/assets/logo/bluepenonly.svg"
                                alt="Bluepen"
                                fill
                                    ...
                                    if (link.comingSoon) {
                                        return (
                                            <div
                                                key={link.href}
                                                className={cn(
                                                    "flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-medium font-poppins cursor-not-allowed opacity-50 select-none",
                                            ...
                                            >
                                                ...
                                                {!collapsed && (
                                                    <span className="flex-1 text-gray-400">{link.label}</span>
                                                )}
                                                {!collapsed && (
                                                    <span className="text-[9px] font-semibold uppercase tracking-[0.08em] px-1.5 py-0.5 rounded-md bg-amber-50 text-amber-500 border border-amber-100">
                                                        Soon
                                                    </span>
                                                )}
                                            </div>
            ...
            >
                ...
                <header className="sticky top-0 z-30 h-16 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-5 lg:px-8">
                    ...
                    <div className="hidden lg:flex items-center gap-2">
                        <span className="text-[10px] uppercase tracking-[0.1em] text-gray-400 font-poppins font-semibold">
                            Freelancer Portal
                        </span>
                    </div>
