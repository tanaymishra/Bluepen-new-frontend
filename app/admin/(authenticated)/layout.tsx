...
const sidebarGroups: SidebarGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { href: "/admin/hrs", label: "HRs", icon: Shield },
            { href: "/admin/employee", label: "Employee", icon: Briefcase },
        ],
    },
    {
        title: "Reports",
        items: [
            { href: "/admin/pm-reports", label: "PM Reports", icon: FileBarChart },
            { href: "/admin/freelancer-reports", label: "Freelancer Reports", icon: FileBarChart2 },
        ],
    },
    {
        title: "Finance",
    ...
    },
    {
        ...
        items: [
            ...
            { href: "/admin/queries", label: "Queries", icon: MessageSquareText },
        ],
    },
];
