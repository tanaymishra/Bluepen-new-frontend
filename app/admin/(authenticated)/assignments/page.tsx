...
export default function AdminAssignmentsPage() {
    ...
    /* active filter count (excluding "all" defaults) */
    ...
    const filtered = useMemo(() => {
        return ADMIN_ASSIGNMENTS.filter((a) => {
            ...
            if (dateFrom && new Date(a.submittedAt) < new Date(dateFrom)) return false;
            if (dateTo && new Date(a.submittedAt) > new Date(dateTo + "T23:59:59"))
                return false;
            return true;
        });
        ...
        <div className="max-w-[1200px] mx-auto">
            ...
            >
                ...
                {activeFilterCount > 0 && (
                    <button
                        onClick={handleReset}
                        className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-[12.5px] font-medium font-poppins text-gray-500 border border-gray-200 bg-white hover:bg-gray-50 transition-all"
                    >
            ...
            >
                ...
                <select
                    ...
                    className="h-10 px-3.5 rounded-xl border border-gray-200 bg-white text-[13px] font-poppins text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary/15 focus:border-primary/30 cursor-pointer min-w-[150px]"
                >
                ...
                <select
                    ...
                    className="h-10 px-3.5 rounded-xl border border-gray-200 bg-white text-[13px] font-poppins text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary/15 focus:border-primary/30 cursor-pointer min-w-[170px]"
                >
                ...
                <div className="flex items-center gap-2">
                    <input
                        ...
                        className="h-10 px-3 rounded-xl border border-gray-200 bg-white text-[12px] font-poppins text-gray-600 focus:outline-none focus:ring-2 focus:ring-primary/15 focus:border-primary/30"
                    />
